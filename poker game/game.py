...
def hand(hole_cards, community_cards):
    ...
    for i in range(12, 4, -1):
        ...
        if len(ranks) == 2:
            ...
            sorted_ranks = [t[0] for t in sorted(ranks, key=lambda x: x[1], reverse=True)]
...
if __name__ == "__main__":
    print(1, hand(['K♥', '7♦'], ['5♦', '10♣', '6♦', '4♦', '3♦']) == ("straight-flush", ['7', '6', '5', '4', '3']))
    print(2, hand(["8♠", "6♠"], ["7♠", "5♠", "9♠", "J♠", "10♠"]) == ("straight-flush", ["J", "10", "9", "8", "7"]))
    print(3, hand(["A♠", "K♦"], ["J♥", "5♥", "10♥", "Q♥", "3♥"]) == ("flush", ["Q", "J", "10", "5", "3"]))
    print(4, hand(["2♠", "3♦"], ["2♣", "2♥", "3♠", "3♥", "2♦"]) == ("four-of-a-kind", ['2', '3']))
    print(5, hand(["A♠", "A♦"], ["K♣", "K♥", "A♥", "Q♥", "3♦"]) == ("full house", ["A", "K"]))
    print(6, hand(["Q♠", "2♦"], ["J♣", "10♥", "9♥", "K♥", "3♦"]) == ("straight", ["K", "Q", "J", "10", "9"]))
    print(7, hand(["4♠", "9♦"], ["J♣", "Q♥", "Q♠", "2♥", "Q♦"]) == ("three-of-a-kind", ["Q", "J", "9"]))
    print(8, hand(["K♠", "J♦"], ["J♣", "K♥", "9♥", "2♥", "3♦"]) == ("two pair", ["K", "J", "9"]))
    print(9, hand(["K♠", "Q♦"], ["J♣", "Q♥", "9♥", "2♥", "3♦"]) == ("pair", ["Q", "K", "J", "9"]))
    print(10, hand(["K♠", "A♦"], ["J♣", "Q♥", "9♥", "2♥", "3♦"]) == ("nothing", ["A", "K", "Q", "J", "9"]))
    print(11, hand(['3♥', '7♣'], ['3♠', '9♠', '3♣', '8♦', '3♦']) == ('four-of-a-kind', ['3', '9']))
    print(12, hand(['2♣', '9♠'], ['9♣', '4♥', '7♣', '2♠', 'K♠']) == ('two pair', ['9', '2', 'K']))
    print(13, hand(['7♦', '3♥'], ['6♦', '7♥', '4♥', '3♦', '3♠']) == ('full house', ['3', '7']))
    print(14, hand(['J♠', '4♠'], ['9♠', '3♠', '5♠', '9♣', '2♠']) == ('flush', ['J', '9', '5', '4', '3']))
    print(13, hand(['4♦', '3♥'], ['J♥', '6♣', '5♠', '4♠', '2♣']) == ('straight', ['6', '5', '4', '3', '2']))
    print(14, hand(['A♥', 'J♥'], ['K♠', 'A♦', 'J♦', '7♣', '3♥']) == ('two pair', ['A', 'J', 'K']))
    print(15, hand(['8♠', '10♣'], ['2♦', '9♥', '9♣', '10♠', 'J♣']) == ('two pair', ['10', '9', 'J']))
    print(1, hand(['9♠', '6♠'], ['10♠', 'J♦', '7♠', '8♥', '8♠']) == ('straight-flush', ['10', '9', '8', '7', '6']))
    # print(1, hand() == )
